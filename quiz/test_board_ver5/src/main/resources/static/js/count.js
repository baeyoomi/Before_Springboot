function unit(x){  // 1의 자리수
	var m = x%10
	return m
}
function tenth(y){   // 10의 자리수
	var m = y/10%10
	m = Math.floor(m)
	return m
}
function hund(v) {    //100의 자리수
	var m = v/100
	m = Math.floor(m)
	return m
}
...
function ddaycount(){
	imgArr = [
		'images/daycount/count_00.png',
		'images/daycount/count_01.png',
		'images/daycount/count_02.png',
		'images/daycount/count_03.png',
		'images/daycount/count_04.png',
		'images/daycount/count_05.png',
		'images/daycount/count_06.png',
		'images/daycount/count_07.png',
		'images/daycount/count_08.png',
		'images/daycount/count_09.png',
	]
	doomsday = new Date('Sept 25, 2023 00:00:00')
