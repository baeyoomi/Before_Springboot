...
import com.example.test.entity.Pagination;
...
public class BoardController {
    ...
    private String showList(BoardForm boardForm, Model model){
        ...
        //Map 을 생성해서 Board 를 저장
        Map<String, Board> memberMap = new HashMap<>();

        //List 를 생성해서 Board 를 저장
    ...
    public String showView(BoardForm boardForm, @PathVariable Integer no, Model model){
        ...
        Optional<Board> list = boardService.selectOneRandomBoard();

        //표시용 Model 에 저장
        model.addAttribute("contlist",list);
