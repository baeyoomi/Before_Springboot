...
public class BoardServiceImpl implements BoardService{
    ...
    void Optional<Board> viewList(Pageable page) {
        int pageNumber = (page.getPageNumber() == 0) ? 0 : (page.getPageNumber() - 1);
        Board sort = (page.getSort().isEmpty()) ? sort.by("logId").descending() : page.getSort();
        return BoardRepository.findAll(PageRequest.of(pageNumber, 10, sort));
    }
}
