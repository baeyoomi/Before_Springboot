...
public class TestController {
    ...
    public String insert(@Validated TestForm testForm, BindingResult bindingResult, Model model, RedirectAttributes redirectAttributes){
        ...
        test.setAnswerqueA(testForm.getAnswerqueA());
        test.setAnswerqueB(testForm.getAnswerqueB());
        test.setAnswerqueC(testForm.getAnswerqueC());
        test.setAnswerqueD(testForm.getAnswerqueD());
    ...
    */
    ...
    private TestForm makeTestForm(Test test) {
        ...
        form.setAnswerqueA(test.getAnswerqueA());
        form.setAnswerqueB(test.getAnswerqueB());
        form.setAnswerqueC(test.getAnswerqueC());
        form.setAnswerqueD(test.getAnswerqueD());
